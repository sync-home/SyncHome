        ...
        <div>
            ...
            <div style={{ border: '1px solid #ccc', borderRadius: '10px', marginBottom: '40px' }}>
                ...
                <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 p-2">
                    ...
                    <CameraLayout path={'59R63qA1jg0?si=5nTZVSuRBkT1J2Ze'} name={'Floor 04 CCTV'} />
                    <CameraLayout path={'NtuKgCMqssY?si=ol70_gHIwJW0rcul'} name={'Floor 05 CCTV'} />
                    <CameraLayout path={'MFsMR1mAPPc?si=rX3jhnWwOn-QFdpL'} name={'Floor 06 CCTV'} />
                </div>
            </div>
