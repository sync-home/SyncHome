    ...
    return (
        <div>
            <div className="text-center bg-[#0A1D56] text-white py-16">
                <h2 className="lg:text-5xl text-4xl uppercase font-extrabold mb-5">About us</h2>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-0">
                ...
                <div className="bg-[#4DAC6A] text-white lg:px-20 px-5 py-16">
                    <h3 className="text-3xl lg:text-4xl font-extrabold mb-5">GOLD STANDARD,<br />BEST MANAGED</h3>
                    ...
                    <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-3 text-black gap-10 mt-14'>
            ...
            <div className="max-w-7xl mx-auto lg:py-28 py-16">
                <div className="text-center text-[#363636]">
                    <h2 className="lg:text-5xl text-3xl uppercase font-extrabold mb-5">Our mission</h2>
                    ...
                    <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10 mt-14'>
            ...
            <div style={{ background: `url(${teamBg.src})` }}>
                <div className="bg-[rgba(77,172,106,0.8)] py-28">
                    <div className="max-w-7xl mx-auto text-center">
                        <h2 className="lg:text-5xl text-3xl text-white uppercase font-extrabold mb-5">Meet our team</h2>
                        <p className="text-white mb-10 px-5">Discover the Faces Behind Our Vision: The Passionate, Diverse Team Driving Innovation Forward with Purpose and Creativity.</p>
                        <div className="grid lg:grid-cols-6 md:grid-cols-2 grid-cols-1 gap-10 mx-5">
                            {teamMembers?.length && teamMembers?.map((member, idx) => <div key={idx} className="lg:max-w-72 w-full lg:mx-auto">
