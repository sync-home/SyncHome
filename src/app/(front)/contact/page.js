    ...
    return (
        <div>
            <div className="text-center bg-[#0A1D56] text-white py-16">
                <h2 className="lg:text-5xl text-4xl uppercase font-extrabold mb-5">Contact us</h2>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-0'>
                ...
                <div className='my-20 lg:mr-20 lg:ml-10 mx-5'>
                    <h2 className="lg:text-5xl text-3xl uppercase font-extrabold mb-5 text-[#363636]">How to reach us</h2>
                    ...
                    <div className='grid md:grid-cols-2 grid-cols-1 lg:gap-0 gap-10 mt-10'>
            ...
            <div style={{background: `url(${contactBg.src}) no-repeat center/cover`}}>
                <div className='bg-[rgba(77,172,106,0.8)] py-28 px-5'>
                    <div className='max-w-7xl mx-auto grid lg:grid-cols-2 grid-cols-1 items-center gap-20'>
                        <div className='text-white'>
                            <h2 className="lg:text-5xl text-3xl uppercase font-extrabold mb-5">Get in Touch</h2>
