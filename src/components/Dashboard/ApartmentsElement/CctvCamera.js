            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide>
                    <div className='relative'>
                        <YouTube videoId={cameraInfo?.bedroom} opts={opts} onReady={handleVideoReady} />
                ...
                <SwiperSlide>
                    <div className='relative'>
                        <YouTube videoId={cameraInfo?.front} opts={opts} onReady={handleVideoReady} />
                        <h4 className='flex absolute top-5 text-sm left-5 items-center gap-2 bg-white text-black rounded-full px-3'><FaDotCircle/> Live</h4>
                        <p className='px-3 bg-gray-300 text-sm rounded-full absolute top-5 right-5 text-black'>{dateTime.toLocaleString()}</p>
                ...
                <SwiperSlide>
                    <div className='relative'>
                        <YouTube videoId={cameraInfo?.kitchen} opts={opts} onReady={handleVideoReady} />
                        <h4 className='flex absolute top-5 text-sm left-5 items-center gap-2 bg-white text-black rounded-full px-3'><FaDotCircle/> Live</h4>
                        <p className='px-3 bg-gray-300 text-sm rounded-full absolute top-5 right-5 text-black'>{dateTime.toLocaleString()}</p>
                ...
                <SwiperSlide>
                    <div className='relative'>
                        <YouTube videoId={cameraInfo?.drawing} opts={opts} onReady={handleVideoReady} />
                        <h4 className='flex absolute top-5 text-sm left-5 items-center gap-2 bg-white text-black rounded-full px-3'><FaDotCircle/> Live</h4>
                        <p className='px-3 bg-gray-300 text-sm rounded-full absolute top-5 right-5 text-black'>{dateTime.toLocaleString()}</p>
