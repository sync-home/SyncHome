            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide>
                    <div className='md:h-[43rem] h-[35rem] relative text-center'>
                        <Image sizes="(max-width: 768px) 100vw, 33vw" height={500} width={500} src='https://i.ibb.co/bgTrtQG/personalized-lighting-control.jpg' alt="hero-image"
                ...
                <SwiperSlide>
                    <div className='md:h-[43rem] h-[35rem] relative text-center'>
                        <Image sizes="(max-width: 768px) 100vw, 33vw" height={500} width={500} src='https://i.ibb.co/VmjzMnJ/augmented-reality-composition-with-computer-generated-perceptual-information.jpg' alt="hero-image"
                            className='h-full w-full object-cover'></Image>
                        <div className='absolute top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.7)] flex flex-col justify-center items-center px-10'>
                ...
                <SwiperSlide>
                    <div className='md:h-[43rem] h-[35rem] relative text-center'>
                    <Image sizes="(max-width: 768px) 100vw, 33vw" height={500} width={500} src='https://i.ibb.co/NCPCT5F/2130.jpg' alt="hero-image"
                            className='h-full w-full object-cover'></Image>
                        <div className='absolute top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.7)] flex flex-col justify-center items-center px-10'>
                ...
                <SwiperSlide>
                    <div className='md:h-[43rem] h-[35rem] relative text-center'>
                    <Image sizes="(max-width: 768px) 100vw, 33vw" height={500} width={500} src='https://i.ibb.co/HVBhv33/Building-and-Facility-management-0-0-0-0-1686046404.jpg' alt="hero-image"
                            className='h-full w-full object-cover'></Image>
                        <div className='absolute top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.7)] flex flex-col justify-center items-center px-10'>
